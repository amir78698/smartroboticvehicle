...
char ssid[] = "amirahmed"; //WiFi Network Name
char pass[] = "amir4929"; //WiFi Network Password
int keyIndex = 0;
...
// set threshold values according to your need (accelerometer and flex sensor)
